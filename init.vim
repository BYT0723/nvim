...
" neovide
if exists("g:neovide")
    set guifont=CaskaydiaCove\ Nerd\ Font\ Light:h9.5
...
nnoremap <leader>fr :FloatermNew --wintype=float --name=ranger --position=center --height=0.8 ranger<CR>
...
autocmd FileType c,javascript,typescript,html,css,xml,yml,yaml,json,vue set softtabstop=2
autocmd FileType c,javascript,typescript,html,css,xml,yml,yaml,json,vue set tabstop=2
autocmd FileType c,javascript,typescript,html,css,xml,yml,yaml,json,vue set shiftwidth=2
